...
// Deep polar-night sky with a subtle vertical gradient plus a faint horizon glow.
		...
		// Royalty-free sample videos (Pexels), verified hotlinkable — offered as
		// one-click starting points so the custom-video card is never a blank box.
		const VIDEO_PRESETS = [
			{ labelKey: "presetBeach", url: "https://videos.pexels.com/video-files/3209828/3209828-uhd_3840_2160_25fps.mp4" },
			{ labelKey: "presetBokeh", url: "https://videos.pexels.com/video-files/3129957/3129957-uhd_2560_1440_25fps.mp4" },
			{ labelKey: "presetCity", url: "https://videos.pexels.com/video-files/2169880/2169880-uhd_2560_1440_30fps.mp4" }
		];
		...
		const zh = {
			...
			"dynbg.auroraDesc": "流动极光帷幕",
				...
				"dynbg.presets": "快速试用：",
				"dynbg.presetBeach": "热带沙滩",
				"dynbg.presetBokeh": "自然光斑",
				"dynbg.presetCity": "城市夜景",
			"dynbg.speed": "速度",
			"dynbg.density": "密度",
			"dynbg.opacity": "界面遮罩",
			"dynbg.blur": "模糊",
		...
		const en = {
			...
			"dynbg.auroraDesc": "Flowing polar lights",
				...
				"dynbg.presetBeach": "Tropical beach",
				"dynbg.presetBokeh": "Soft bokeh",
				"dynbg.presetCity": "City night",
			"dynbg.speed": "Speed",
		...
		function preloadVideo(url) {
			...
			entry.timer = setTimeout(() => settle(() => reportVideoError?.("timeout")), 12000);
