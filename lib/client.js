		...
		function applyWallpaper(ctx) {
			...
			try {
				...
				if (type === "custom") {
					...
					// be freed now that the element has switched to the new URL.
		...
		function WallpaperRow({ t, setType, setSpeed, setDensity, setOpacity, setBlur, setVideo, useStore }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					error ? (0, react_jsx_runtime.jsx)("div", { style: styles.error, children: t(error === "video" ? (videoUrl?.startsWith("blob:") ? "dynbg.errorBlob" : "dynbg.errorVideo") : error === "save" ? "dynbg.errorSave" : "dynbg.errorInvalid") }) : null,
